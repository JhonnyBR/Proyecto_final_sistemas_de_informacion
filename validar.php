		...
		while($fila = $consulta->fetch_assoc()){
			if($pass==$fila["clave"]){
				...
				if($_SESSION['Rol']=="Administrador"){
					header("Location:http://postoean.freecluster.eu/admin.php");
					...
					header("Location:http://postoean.freecluster.eu/precios.php");
					...
					$_SESSION['USER']=$user;
					$_SESSION['pass']=$pass;
					header("Location:http://postoean.freecluster.eu/produccion.php");
				}
				
			}else{
				header("refresh:0.1;url=http://postoean.freecluster.eu/");
